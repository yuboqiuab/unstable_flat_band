...
plt.axvline(0.2498, linewidth=1.25, color='k', alpha=1.0)
plt.axvline(0.7374, linewidth=1.25, color='k', alpha=1.0)
plt.axvline(0.9871, linewidth=1.25, color='k', alpha=1.0)

plt.axvline(1.4943, linewidth=1.25, color='k', alpha=1.0)
plt.axvline(1.9820, linewidth=1.25, color='k', alpha=1.0)
plt.axvline(2.2317, linewidth=1.25, color='k', alpha=1.0)
...
plt.xticks(ticks= [0, 0.2498, 0.7374, 0.9871, 1.4943, 1.9820, 2.2317, 2.7194], \
